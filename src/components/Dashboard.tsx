...
export function Dashboard() {
  ...
  const handleManualRefresh = useCallback(() => {
    load().then(() => {
      setAnnouncement("Signals dataset refreshed");
    });
  }, [load]);

  const toggleShortcutsHelp = useCallback(() => {
    setShowShortcutsHelp((prev) => {
      const next = !prev;
      setAnnouncement(
        next
  ...
  }, [handleManualRefresh, toggleTheme, toggleShortcutsHelp, showShortcutsHelp]);
    ...
    <div className="console">
      ...
      <header className="console__header" role="banner">
        ...
        <div className="console__header-right">
          ...
          >
            ...
            <kbd className="shortcut-hint" aria-hidden="true">T</kbd>
          </button>
        </div>
      </header>
      ...
      <main id="main-content" className="console__main" tabIndex={-1}>
        ...
        <section className="card" aria-labelledby="signals-title">
          <div className="signals__head">
            <div className="signals__title-group">
              ...
              <button
                ...
                aria-label="Refresh signals dataset (Shortcut: R)"
          ...
          {loading ? (
            <p className="muted" role="status" aria-live="polite">Loading…</p>
          ) : (
            <div className="table-wrap">
              <table aria-labelledby="signals-title">
                <caption className="sr-only">
                  List of system signals, their origin, current status, intensity level, and recorded timestamp.
                </caption>
                <thead>
                  <tr>
          ...
          >
            ...
            <div className="modal-body">
              <dl className="shortcuts-list">
                ...
                <div className="shortcut-row">
                  <dt><kbd>?</kbd></dt>
                  <dd>Toggle this shortcuts help dialog</dd>
                </div>
                <div className="shortcut-row">
                  <dt><kbd>Esc</kbd></dt>
                  <dd>Close dialog</dd>
