...
export function Dashboard() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // '?' or 'h' key toggles shortcuts help dialog
  ...
  }, [toggleTheme, load, toggleHelpModal, isHelpOpen]);
  ...
  return (
    <div className="console">
      ...
      <main id="main-content" tabIndex={-1} ref={mainContentRef} role="main">
        ...
        <section className="card" aria-labelledby="signals-title">
          ...
          {loading ? (
            ...
            <div className="table-wrap" tabIndex={0} role="region" aria-label="Signals data table">
              <table>
                <caption className="sr-only">Signals list displaying name, origin, status, intensity, and recorded date</caption>
                <thead>
                  <tr>
            ...
            <div className="modal-card__body">
              <dl className="shortcut-list">
                ...
                <div className="shortcut-item">
                  ...
                  <dd>Toggle this keyboard shortcuts menu</dd>
                </div>
                <div className="shortcut-item">
                  <dt><kbd>Esc</kbd></dt>
                  <dd>Close shortcuts menu</dd>
                </div>
              </dl>
            </div>
          </div>
