...
export function Dashboard() {
  ...
  const load = useCallback(() => {
    setAnnouncement("Refreshing signals data...");
    fetchSignals().then((r) => {
      setResult(r);
      const now = new Date();
      setLastUpdated(now);
      setAnnouncement("Signals data updated");
    });
  }, []);

  useEffect(() => {
    // Initial fetch signals
    fetchSignals().then((r) => {
      setResult(r);
  ...
  }, [isShortcutsOpen, load, toggleTheme]);
        ...
        <header className="console__header" role="banner">
          ...
          <div className="console__header-right">
            ...
            <button
              ...
              title="Refresh signals data (Key: R)"
            >
              <svg
                width="16"
                height="16"
            ...
            <button
              ...
              data-theme-toggle
              onClick={toggleTheme}
              aria-label={`Switch to ${theme === "dark" ? "light" : "dark"} mode (Key: T)`}
              ...
              <div className="table-wrap">
                <table aria-label="Signals list">
                  <caption className="sr-only">
                    List of signals with origin, status, intensity, and time recorded.
                  </caption>
                  <thead>
                    <tr>
        ...
        >
          ...
          >
            ...
            <ul className="shortcut-list">
              ...
              <li className="shortcut-item">
                <span>Close dialogs or modals</span>
                <div className="shortcut-keys">
                  <kbd>Esc</kbd>
                </div>
              </li>
  ...
  return (
    <tr>
      ...
      <td
        ...
        aria-label={`Recorded at ${recorded.toLocaleString()}`}
      >
        {timeAgo(recorded)}
      </td>
    </tr>
